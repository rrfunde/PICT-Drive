...
{
    const_str_plain_cwd = UNSTREAM_STRING( &constant_bin[ 246512 ], 3, 1 );
    const_str_plain_PIPE = UNSTREAM_STRING( &constant_bin[ 246515 ], 4, 1 );
    const_str_plain_Popen = UNSTREAM_STRING( &constant_bin[ 246519 ], 5, 1 );
    const_str_plain_shell = UNSTREAM_STRING( &constant_bin[ 246524 ], 5, 1 );
    const_unicode_plain_b = UNSTREAM_UNICODE( &constant_bin[ 6 ], 1 );
    const_unicode_plain_c = UNSTREAM_UNICODE( &constant_bin[ 9 ], 1 );
    const_str_plain_stderr = UNSTREAM_STRING( &constant_bin[ 246529 ], 6, 1 );
    const_str_plain_stdout = UNSTREAM_STRING( &constant_bin[ 246535 ], 6, 1 );
    const_unicode_plain_rc = UNSTREAM_UNICODE( &constant_bin[ 6830 ], 2 );
    const_str_plain_git_log = UNSTREAM_STRING( &constant_bin[ 246541 ], 7, 1 );
    const_str_plain_repo_dir = UNSTREAM_STRING( &constant_bin[ 246548 ], 8, 1 );
    const_unicode_plain_beta = UNSTREAM_UNICODE( &constant_bin[ 246556 ], 4 );
    const_str_plain_timestamp = UNSTREAM_STRING( &constant_bin[ 27443 ], 9, 1 );
    const_unicode_plain_alpha = UNSTREAM_UNICODE( &constant_bin[ 192276 ], 5 );
    const_unicode_plain_final = UNSTREAM_UNICODE( &constant_bin[ 78780 ], 5 );
    const_str_plain_subprocess = UNSTREAM_STRING( &constant_bin[ 27364 ], 10, 1 );
    const_str_plain_communicate = UNSTREAM_STRING( &constant_bin[ 246560 ], 11, 1 );
    const_str_plain_git_changeset = UNSTREAM_STRING( &constant_bin[ 27130 ], 13, 1 );
    const_str_plain_unicode_literals = UNSTREAM_STRING( &constant_bin[ 246571 ], 16, 1 );
    const_str_plain_utcfromtimestamp = UNSTREAM_STRING( &constant_bin[ 246587 ], 16, 1 );
    const_str_plain_get_git_changeset = UNSTREAM_STRING( &constant_bin[ 27126 ], 17, 1 );
    const_str_plain_universal_newlines = UNSTREAM_STRING( &constant_bin[ 246603 ], 18, 1 );
    ...
    const_str_digest_70431bb1d1820641133fda212bdca498 = UNSTREAM_STRING( &constant_bin[ 246621 ], 56, 0 );
    ...
    const_unicode_digest_0741003367f051f80c9aa6286f69c4aa = UNSTREAM_UNICODE( &constant_bin[ 246677 ], 56 );
    const_unicode_digest_3f62daf1d921db9a1d9a0b7d7d82ac63 = UNSTREAM_UNICODE( &constant_bin[ 246733 ], 6 );
    const_unicode_digest_94bcb5e0b07765669dd2c0ecb185824f = UNSTREAM_UNICODE( &constant_bin[ 246739 ], 293 );
    const_unicode_digest_9749e6c8182f9339ffc2fc75ab27c2be = UNSTREAM_UNICODE( &constant_bin[ 247032 ], 12 );
    const_unicode_digest_ee26ac064d5f44bbd868135656cb4611 = UNSTREAM_UNICODE( &constant_bin[ 247044 ], 43 );
...
static PyObject *impl_function_1_get_version_of_module_django$utils$version( Nuitka_FunctionObject *self, PyObject *_python_par_version )
{
    ...
    if ( tmp_called_2 == NULL )
    {
        ...
        exception_value = UNSTREAM_STRING( &constant_bin[ 27113 ], 46, 0 );
        exception_tb = NULL;
    ...
    if ( tmp_binop_left_3 == NULL )
    {
        ...
        exception_type = INCREASE_REFCOUNT( PyExc_UnboundLocalError );
        exception_value = UNSTREAM_STRING( &constant_bin[ 27159 ], 50, 0 );
        exception_tb = NULL;
    ...
    if ( tmp_binop_right_3 == NULL )
    {
        ...
        exception_type = INCREASE_REFCOUNT( PyExc_UnboundLocalError );
        exception_value = UNSTREAM_STRING( &constant_bin[ 27209 ], 49, 0 );
        exception_tb = NULL;
...
static PyObject *impl_function_2_get_git_changeset_of_module_django$utils$version( Nuitka_FunctionObject *self )
{
    ...
    if ( tmp_call_arg_element_3 == NULL )
    {
        ...
        exception_type = INCREASE_REFCOUNT( PyExc_NameError );
        exception_value = UNSTREAM_STRING( &constant_bin[ 27314 ], 37, 0 );
        exception_tb = NULL;
    ...
    if ( tmp_source_name_7 == NULL )
    {
        ...
        exception_type = INCREASE_REFCOUNT( PyExc_NameError );
        exception_value = UNSTREAM_STRING( &constant_bin[ 27351 ], 39, 0 );
        exception_tb = NULL;
    ...
    if ( tmp_source_name_12 == NULL )
    {
        ...
        exception_type = INCREASE_REFCOUNT( PyExc_NameError );
        exception_value = UNSTREAM_STRING( &constant_bin[ 27390 ], 37, 0 );
        exception_tb = NULL;
    ...
    if ( tmp_source_name_13 == NULL )
    {
        ...
        exception_type = INCREASE_REFCOUNT( PyExc_UnboundLocalError );
        exception_value = UNSTREAM_STRING( &constant_bin[ 27427 ], 55, 0 );
        exception_tb = NULL;
