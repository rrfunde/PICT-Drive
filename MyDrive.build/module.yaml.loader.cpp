...
{
    const_str_plain_BaseLoader = UNSTREAM_STRING( &constant_bin[ 353112 ], 10, 1 );
    const_str_digest_26f8bfacb677d60fac0aa8b891715cab = UNSTREAM_STRING( &constant_bin[ 356049 ], 53, 0 );
    const_str_digest_546554298af0f9a89dae62dad7fd1c20 = UNSTREAM_STRING( &constant_bin[ 356102 ], 11, 0 );
...
static PyObject *impl_function_1___init___of_class_1_BaseLoader_of_module_yaml$loader( Nuitka_FunctionObject *self, PyObject *_python_par_self, PyObject *_python_par_stream )
{
    ...
    if ( tmp_source_name_1 == NULL )
    {
        ...
        exception_value = UNSTREAM_STRING( &constant_bin[ 65211 ], 35, 0 );
        exception_tb = NULL;
    ...
    if ( tmp_source_name_2 == NULL )
    {
        ...
        exception_type = INCREASE_REFCOUNT( PyExc_NameError );
        exception_value = UNSTREAM_STRING( &constant_bin[ 65246 ], 36, 0 );
        exception_tb = NULL;
    ...
    if ( tmp_source_name_3 == NULL )
    {
        ...
        exception_type = INCREASE_REFCOUNT( PyExc_NameError );
        exception_value = UNSTREAM_STRING( &constant_bin[ 65282 ], 35, 0 );
        exception_tb = NULL;
    ...
    if ( tmp_source_name_4 == NULL )
    {
        ...
        exception_type = INCREASE_REFCOUNT( PyExc_NameError );
        exception_value = UNSTREAM_STRING( &constant_bin[ 65317 ], 37, 0 );
        exception_tb = NULL;
...
// doesn't automatically enter "sys.modules", so do it manually.
    ...
    if ( tmp_tuple_element_1 == NULL )
    {
        ...
        exception_type = INCREASE_REFCOUNT( PyExc_NameError );
        exception_value = UNSTREAM_STRING( &constant_bin[ 65096 ], 28, 0 );
        exception_tb = NULL;
    ...
    if ( tmp_tuple_element_1 == NULL )
    {
        Py_DECREF( tmp_assign_source_4 );
        exception_type = INCREASE_REFCOUNT( PyExc_NameError );
        exception_value = UNSTREAM_STRING( &constant_bin[ 65124 ], 29, 0 );
        exception_tb = NULL;
    ...
    if ( tmp_tuple_element_1 == NULL )
    {
        Py_DECREF( tmp_assign_source_4 );
        exception_type = INCREASE_REFCOUNT( PyExc_NameError );
        exception_value = UNSTREAM_STRING( &constant_bin[ 65153 ], 28, 0 );
        exception_tb = NULL;
    ...
    if ( tmp_tuple_element_1 == NULL )
    {
        Py_DECREF( tmp_assign_source_4 );
        exception_type = INCREASE_REFCOUNT( PyExc_NameError );
        exception_value = UNSTREAM_STRING( &constant_bin[ 65181 ], 30, 0 );
        exception_tb = NULL;
